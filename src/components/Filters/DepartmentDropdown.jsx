...
function DepartmentDropdown({ filtersBarRef, setSelectedDepartments, selectedDepartments, departments }) {
            ...
            {departments.map((department) => (
              <li key={department.id} className="flex items-center">
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className={`w-[19px] h-[19px] inline-flex justify-center items-center rounded-[5px] border-[1.5px] mr-[15px] border-[#8338EC]`}>
                ...
                <label htmlFor={`department-${department.id}`} className="font-style-1 cursor-pointer">
                  {department.name}
                </label>
              </li>
            ))}
