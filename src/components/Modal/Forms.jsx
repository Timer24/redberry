        ...
        return (
            <div className="w-[127px] h-[34px] absolute bottom-1 flex flex-wrap items-center gap-x-2 gap-y-0">
                    <div className="flex items-center gap-x-1">
                        ...
                        <p className={`font-sans font-normal text-[10px] leading-[100%] ${textColor} whitespace-nowrap`}>მინიმუმ 2 სიმბოლო</p>
                    </div>
                    <div className="flex items-center gap-x-1">
                        <IoMdCheckmark className = {`w-[16px] h-[16px] ${textColor}`}/>
                        <p className={`font-sans font-normal text-[10px] leading-[100%] ${textColor} whitespace-nowrap`}>მაქსიმუმ 255 სიმბოლო</p>
                    </div>
            </div>
        )
    }
