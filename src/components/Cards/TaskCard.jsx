...
function TaskCard({ task }) {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className={`w-[381px] h-[217px] bg-white p-6 rounded-[10px] shadow-sm mb-4 cursor-move border ${statusColors[task.status.id]} border-[1px] flex flex-col justify-between`}
    >
